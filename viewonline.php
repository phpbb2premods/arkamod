		...
		if ( $row['session_page'] < 1 || !$is_auth_ary[$row['session_page']]['auth_view'] )
		{
			switch( $row['session_page'] )
			{
				...
				case PAGE_FAQ:
					...
					break;
				case PAGE_RAB:
					$location = $lang['Viewing_RAB'];
					$location_url = "../rabbitoshi.$phpEx?pane=right";
					break;
				case PAGE_RABINV:
					$location = $lang['Viewing_RABINV'];
					$location_url = "../rabbitoshi_inventory.$phpEx?pane=right";
					break;
				case PAGE_RABPRO:
					$location = $lang['Viewing_RABPRO'];
					$location_url = "../rabbitoshi_progress.$phpEx?pane=right";
					break;
				case PAGE_RABSHO:
					$location = $lang['Viewing_RABSHO'];
					$location_url = "../rabbitoshi_shop.$phpEx?pane=right";
					break;
                case PAGE_ADR:
                    ...
                    break;
                case PAGE_HANGMAN:
                    $location = 'Jeu du Pendu en ligne';
