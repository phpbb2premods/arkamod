...
//-- mod : browsers list -------------------------------------------------------
//-- add
	$browser = request_var('browser', TYPE_NO_HTML);
...
//-- mod : browsers list -------------------------------------------------------
//-- add
			$sql = str_replace('SET ', 'SET user_browser = \'' . str_replace("\'", "''", $browser) . '\', ', $sql);
//-- fin mod : browsers list ---------------------------------------------------
//-- mod : signature editor preview deluxe -------------------------------------
//-- add
			$sql = str_replace(', user_interests = \'' . str_replace("\'", "''", $interests) . '\', user_sig = \'' . str_replace("\'", "''", $signature) . '\', user_sig_bbcode_uid = \'' . $signature_bbcode_uid . '\'', ', user_interests = \'' . str_replace("\'", "''", $interests) . '\'', $sql);
...
//-- mod : browsers list -------------------------------------------------------
//-- add
	$browser = htmlspecialchars($userdata['user_browser']);
//-- fin mod : browsers list ---------------------------------------------------
//-- mod : birthday ------------------------------------------------------------
//-- add
...
//	, $flag
//-- modify
	display_avatar_gallery($mode, $avatar_category, $user_id, $email, $current_email, $email_confirm, $coppa, $username, $email, $email_confirm, $new_password, $cur_password, $password_confirm, $icq, $aim, $msn, $yim, $website, $location, $occupation, $interests, $flag, $browser, $bday_day, $bday_month, $bday_year, $signature, $viewemail, $notifypm, $popup_pm, $notifyreply, $attachsig, $allowhtml, $allowbbcode, $allowsmilies, $allowviewonline, $user_style, $user_lang, $user_timezone, $user_dateformat, $userdata['session_id'], $user_qp_settings);
//-- fin mod : flags -----------------------------------------------------------
//-- fin mod : browsers list ---------------------------------------------------
//-- fin mod : birthday --------------------------------------------------------
//-- fin mod : quick post es ---------------------------------------------------
...
//-- fin mod : signature editor preview deluxe ---------------------------------
    ...
    // End Account Self-Delete MOD
		...
		// Start add - Email Confirmation
		'L_EMAIL_CONFIRM' => $lang['Email_confirm'],
		'L_EMAIL_EMPTY' => $lang['Email_empty'],
		'L_EMAIL_MISMATCH' => $lang['Email_mismatch'],
