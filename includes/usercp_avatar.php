...
//	, &$flag
//-- modify
function display_avatar_gallery($mode, &$category, &$user_id, &$email, &$current_email, &$email_confirm, &$coppa, &$username, &$email, &$email_confirm, &$new_password, &$cur_password, &$password_confirm, &$icq, &$aim, &$msn, &$yim, &$website, &$location, &$occupation, &$interests, &$flag, &$browser, &$bday_day, &$bday_month, &$bday_year, &$signature, &$viewemail, &$notifypm, &$popup_pm, &$notifyreply, &$attachsig, &$allowhtml, &$allowbbcode, &$allowsmilies, &$hideonline, &$style, &$language, &$timezone, &$dateformat, &$session_id, &$user_qp_settings)
//-- fin mod : flags -----------------------------------------------------------
...
//	, 'flag'
//-- modify
	$params = array('coppa', 'user_id', 'username', 'email', 'current_email', 'email_confirm', 'cur_password', 'new_password', 'password_confirm', 'icq', 'aim', 'msn', 'yim', 'website', 'location', 'occupation', 'interests', 'flag'
, 'browser', 'bday_day', 'bday_month', 'bday_year', 'signature', 'viewemail', 'notifypm', 'popup_pm', 'notifyreply', 'attachsig', 'allowhtml', 'allowbbcode', 'allowsmilies', 'hideonline', 'style', 'language', 'timezone', 'dateformat', 'user_qp', 'user_qp_show', 'user_qp_subject', 'user_qp_bbcode', 'user_qp_smilies', 'user_qp_more');
//-- fin mod : flags -----------------------------------------------------------
//-- fin mod : browsers list ---------------------------------------------------
//-- fin mod : birthday --------------------------------------------------------
//-- fin mod : quick post es ---------------------------------------------------
