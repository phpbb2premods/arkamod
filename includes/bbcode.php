...
// end url-ed2k 
   ...
   $patterns[] = "#\[$youtube:$uid\]http://(?:[^\.]+\.)*youtube\.[a-z0-9\-_]+/watch.*[&\?]v=([a-z0-9\-_]{11})[^\[]*\[/$youtube:$uid\]#is";
...
//-- fin mod : bbcode box reloaded ---------------------------------------------
   ...
   $text = ($bbc_value['youtube'] && $bbc_sort) ? preg_replace("#\[$youtube\]http://(?:[^\.]+\.)*youtube\.[a-z0-9\-_]+/watch.*[&\?]v=([a-z0-9\-_]{11})[^\[]*\[/$youtube\]#is", "[$youtube:$uid]http://youtube.com/watch?v=\\1[/$youtube:$uid]", $text) : $text;
