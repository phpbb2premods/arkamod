...
//-- add
         'arkamod' => array(
            'author' => 'EzCom',
            'author_url' => 'http://www.ezcom-fr.fr',
            'host' => 'demo.ezcom-fr.fr',
            'file' => '/premod_version_check/arkamod_versions.dta',
            'protocol' => 'multiple',
            'mods' => array(
               'arkamod_version' => array('name' => 'ArkaMod', 'desc' => '', 'page' => 'http://www.ezcom-fr.fr/viewtopic.php?t=8255'),
            ),
         ),
//-- fin mod : arkamod ---------------------------------------------------------
		);
