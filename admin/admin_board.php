...
$karmap_yes = ( $new['karmap'] ) ? "checked=\"checked\"" : "";
$karmap_no = ( !$new['karmap'] ) ? "checked=\"checked\"" : "";

$karmav_yes = ( $new['karmav'] ) ? "checked=\"checked\"" : "";
$karmav_no = ( !$new['karmav'] ) ? "checked=\"checked\"" : "";
...
$template->assign_vars(array(
  ...
  // End Account Self-Delete MOD
	...
	"L_KARMAP" => $lang['karmap'],
	"L_KARMAV" => $lang['karmav'],
  ...
  // End Account Self-Delete MOD
	...
	"PRUNE_YES" => $prune_yes,
	"PRUNE_NO" => $prune_no, 
	"KARMAP_YES" => $karmap_yes,
	"KARMAP_NO" => $karmap_no,
	"KARMAV_YES" => $karmav_yes,
	"KARMAV_NO" => $karmav_no,
	"HTML_TAGS" => $html_tags, 
	"HTML_YES" => $html_yes,
	"HTML_NO" => $html_no,
