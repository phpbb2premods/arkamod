...
if( empty($forum_id) )
{
	...
	{
				$forum_name_link = ( !empty($forum_rows[$i]['forum_link']) ) ? '&raquo; ' . $forum_rows[$i]['forum_name'] : $forum_rows[$i]['forum_name'];
		$select_list .= '<option value="' . $forum_rows[$i]['forum_id'] . '">' . $forum_name_link . '</option>';
