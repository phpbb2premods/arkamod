	...
	switch($mode)
	{
		case 'list':
			...
			for ($l = 1 ; $l < count($items_type) ; $l++ )
			{
				...
				$item_type .= '<option value = "'.$items_type[$l]['item_type_id'].'" '.$selected.'>' . $lang[$items_type[$l]['item_type_lang']] . '</option>';
			}
			$item_type .= '</select>';
			return $item_type;
			break;
		...
		case 'search':
			...
			{
				$item_type .= '<option value = "'.$items_type[$l]['item_type_id'].'" >' . $lang[$items_type[$l]['item_type_lang']] . '</option>';
			}
			$item_type .= '</select>';
			return $item_type;
			break;
		...
		case 'simple':
			...
			$item_type = $lang[$items_type[$type]['item_type_lang']];
			return $item_type;
			break;
