...
$lang['xs_main_comment1'] = 'Ceci est le menu principal du MOD eXtreme Styles. Il y a nombre de fonctions à travers cette interface, cette page se présente donc comme un guide. Une petite explication se trouve en dessous de chaque fonction.<br /><br />Note: Ce MOD remplace le système de gestion des thèmes de phpBB. Vous trouverez les fonctions par défaut de phpBB dans cette liste, mais celles-ci seront optimisées et auront de nouvelles fonctionnalités.<br /><br />Pour toutes questions n\'hésitez pas à visiter <a href="http://www.phpbbstyles.com" target="_blank">le forum de support</a> où vous pourrez trouver de l\'aide pour ce MOD.';
$lang['xs_main_comment2'] = 'Le MOD eXtreme Styles permet à l\'administrateur de stocker des thèmes entiers dans des fichiers .style . Les thèmes sont stockés dans de petits fichiers compressés et ainsi permettent d\'éviter les téléchargements/uploads incéssants de nombreux fichiers. Les fichiers .style sont compressés et permettent que le téléchargement/upload soit plus efficace que l\'actuel téléchargement/upload des fichiers de thèmes.';
$lang['xs_main_comment3'] = 'Toutes les fonctions de gestion de thèmes de phpBB sont remplacés par eXtreme Styles MOD.<br /><br /><a href="{URL}">Cliquer ici</a> pour voir le menu.';
...
$lang['xs_edit_templates_lc'] = 'éditer des templates';
$lang['xs_edit_styles_data_lc'] = 'éditer des variables des thèmes';
...
$lang['xs_ftp_comment2'] = 'Pour utiliser cette fonctionnalité, vous devez régler la configuration du FTP. Un mot de passe ne sera pas gardé et eXtreme Styles vous demandera un mot de passe à chaque fois que vous voudrez accéder à une fonction nécéssitant un accès FTP.';
...
$lang['xs_config_warning_explain'] = 'Le répertoire du cache n\'est pas inscriptible. eXtreme Styles peut tenter de réparer ce problème.<br /><a href="{URL}">Cliquer ici</a> pour essayer de changer l\'accès au répertoire du cache.<br /><br />Si le cache ne fonctionne pas sur votre serveur pour quelquonque raison, ne vous inquiétez pas - eXtreme Styles<br />augmente assez notabelement la vitesse de votre forum même sans cache.';
...
$lang['xs_styles_do_override'] = 'écraser les préférences de l\'utilisateur';
...
$lang['xs_import_explain'] = 'Ceci vous permet d\'importer des thèmes et peut aussi installer et mettre à jour automatiquement des thèmes.<br /><br />Note: si vous avez installé quelquonque MODs (excepté eXtreme Styles MOD) sur ce forum, faites attention lorsque vous importez des thèmes car des thèmes peuvent ne pas être compatible avec votre forum. Vous pouvez uniquement installer des thèmes qui ont les même modifications que les autres thèmes que vous avez configuré sur votre forum.';
...
$lang['xs_export_style_names'] = 'Selectionner le thème(s) à exporter';
...
$lang['xs_import_download_warning'] = 'Ceci vous amènera sur un site web externe où vous pourrez repidement télécharger des thèmes avec simplement quelques clics en utilisant le système d\'importation d\'eXtreme Styles.';
...
$lang['xs_fileedit_backups_save_lc'] = 'sauver le backup';
...
$lang['xs_editdata_explain'] = 'Ceci vous permet d\'éditer les données de la base de données pour les thèmes installés. Certains thèmes ignores les valeurs de la base de données et utilisent les fichiers css à la place, et certains thèmes utilisent uniquement les valeurs de la base de données.';
