...
{POSTER_USERNAME} vous a envoyé un message privé sur "{SITENAME}" et avez demandé à être averti dans ce cas. Vous pouvez voir votre nouveau message en cliquant sur le lien suivant:
