...
<form action="{S_CONFIG_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
   	...
   	<tr>
      		<td class="row1">{L_KARMAP}</td>
      		<td class="row2"><input type="radio" name="karmap" value="1" {KARMAP_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="karmap" value="0" {KARMAP_NO} /> {L_NO}</td>
   	</tr>
   	<tr>
      		<td class="row1">{L_KARMAV}</td>
      		<td class="row2"><input type="radio" name="karmav" value="1" {KARMAV_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="karmav" value="0" {KARMAV_NO} /> {L_NO}</td>
   	</tr>
	<tr>
