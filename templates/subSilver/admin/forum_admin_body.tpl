...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<!-- BEGIN forumrow -->
	<tr> 
		<td class="row2"><span class="gen">{catrow.forumrow.FORUM_ICON_IMG}&nbsp;&nbsp;
...
<!-- END row -->
<!-- BEGIN link -->
		<td class="row2" align="center" valign="middle" colspan="2"><span class="gen">{catrow.forumrow.FORUM_LINK}</span></td>
<!-- END link -->
