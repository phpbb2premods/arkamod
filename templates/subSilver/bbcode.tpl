...
<object width="425" height="350">
  <param name="movie" value="http://www.dailymotion.com/swf/{DAILYMOTIONID}"pascontent/param>
  <embed src="http://www.dailymotion.com/swf/{DAILYMOTIONID}" type="application/x-shockwave-flash" width="425" height="350"pascontent/embed>
</object><br />
