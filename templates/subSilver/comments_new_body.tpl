...
<table width="80%" cellpadding="5" cellspacing="1" border="0" class="forumline" align="center">
	  <tr> 
		<th class="thTop" colspan='3' >{CONGRATULATIONS}!</th>
	  </tr>
	<tr>
		<td align='center' class='row2' colspan='3' ><span class="gen"><b>{L_NEW_CHAMPION}</b></span></td>
	</tr>
</table>
<br />
...
<table width="80%" cellpadding="5" cellspacing="1" border="0" class="forumline" align="center">
	<tr> 
		<td colspan='3' align='center' class='row2'><span class="gen">{RETURN_ARCADE}</span></td>
	</tr>
	<tr>	
		<td valign="middle" align="center" class='row2' width="20%"> <br />
		...
		<td class='row2' align="center">
			...
			<tr align="center" valign="middle"> 
				...
				<td><span class="genmed"> &nbsp;{L_FONT_SIZE}:<select name="addbbcode20" onChange="bbfontstyle('[size=' + this.form.addbbcode20.options[this.form.addbbcode20.selectedIndex].value + ']', '[/size]')" onMouseOver="helpline('f')">
...
<table width="80%" cellpadding="5" cellspacing="1" border="0" class="forumline" align="center">
<tr> 
  	<th class="thTop" colspan='2'>{QUICK_STATS}</th>
  </tr>
	<tr>
		<td class='row2' align="center" width="30%"><span class="gen">{USERNAME}</span><br>{USER_AVATAR}</td>
		<td class='row2' > <span class="gen">{YOURS_QUICK_STATS}</span>
	</tr>   		
</table>
<br />
